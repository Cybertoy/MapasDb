		...
		if (id > 0) {
			...
			try {
				...
				if (cursor.moveToFirst()) {
					...
					TextView.class.cast(this.findViewById(R.id.label_nombre)).setText(nombre);
					TextView.class.cast(this.findViewById(R.id.label_descripcion)).setText(descripcion);
